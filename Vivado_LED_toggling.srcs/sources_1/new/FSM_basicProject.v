...
always  @(*)
begin
if(iLeft && rShapeX_current != 10'd0 && memX == 0)
begin
    rShapeX_next <= rShapeX_current - 10'd1;
    memX <= 1;
end
else if(iRight && rShapeX_current != 10'd580&& memX == 0)
begin
    rShapeX_next <= rShapeX_current + 10'd1;
    memX <= 1;
end
...
always @(*)
begin
if(iUp && rShapeY_current != 10'd0 && memY == 0)
begin
    rShapeY_next <= rShapeY_current - 10'd1;
    memY <= 1;
end
else if(iDown && rShapeY_current != 10'd420 && memY == 0)
begin
    rShapeY_next <= rShapeY_current + 10'd1;
    memY <= 1;
end
