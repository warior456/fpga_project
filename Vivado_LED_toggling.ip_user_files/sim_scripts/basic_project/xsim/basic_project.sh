...
#
# Script generated by Vivado on Thu Nov 13 12:54:23 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : basic_project.sh
...
#
# Usage        : basic_project.sh
#                basic_project.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                basic_project.sh [-reset_run]
#                basic_project.sh [-reset_log]
#                basic_project.sh [-help]
#
...
# script info
echo -e "basic_project.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./basic_project.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconcat_v2_1_7 -L xlconstant_v1_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot basic_project xil_defaultlib.basic_project xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim basic_project -key {Behavioral:sim_1:Functional:basic_project} -tclbatch cmd.tcl -protoinst "protoinst_files/basic_project.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xlconcat_v2_1_7 xlconstant_v1_1_10)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb basic_project.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./basic_project.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: basic_project.sh [-help]\n\
Usage: basic_project.sh [-step]\n\
Usage: basic_project.sh [-lib_map_path]\n\
Usage: basic_project.sh [-reset_run]\n\
Usage: basic_project.sh [-reset_log]\n\
Usage: basic_project.sh [-keep_index]\n\
Usage: basic_project.sh [-noclean_files]\n\n\
