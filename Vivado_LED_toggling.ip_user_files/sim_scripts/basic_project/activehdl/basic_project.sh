...
#                script (type 'basic_project.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Jorbe/Vivado_project/fpga_project/Vivado_LED_toggling.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
