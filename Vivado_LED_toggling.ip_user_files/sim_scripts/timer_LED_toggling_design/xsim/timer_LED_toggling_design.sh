...
#
# Script generated by Vivado on Thu Nov 13 10:56:45 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : timer_LED_toggling_design.sh
...
#
# Usage        : timer_LED_toggling_design.sh
#                timer_LED_toggling_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                timer_LED_toggling_design.sh [-reset_run]
#                timer_LED_toggling_design.sh [-reset_log]
#                timer_LED_toggling_design.sh [-help]
#
...
# script info
echo -e "timer_LED_toggling_design.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./timer_LED_toggling_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot timer_LED_toggling_design xil_defaultlib.timer_LED_toggling_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim timer_LED_toggling_design -key {Behavioral:sim_1:Functional:timer_LED_toggling_design} -tclbatch cmd.tcl -protoinst "protoinst_files/timer_LED_toggling_design.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb timer_LED_toggling_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./timer_LED_toggling_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: timer_LED_toggling_design.sh [-help]\n\
Usage: timer_LED_toggling_design.sh [-step]\n\
Usage: timer_LED_toggling_design.sh [-lib_map_path]\n\
Usage: timer_LED_toggling_design.sh [-reset_run]\n\
Usage: timer_LED_toggling_design.sh [-reset_log]\n\
Usage: timer_LED_toggling_design.sh [-keep_index]\n\
Usage: timer_LED_toggling_design.sh [-noclean_files]\n\n\
