...
#                script (type 'timer_LED_toggling_design.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/labosDigOnt/final_vivado_project/Vivado_LED_toggling.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
