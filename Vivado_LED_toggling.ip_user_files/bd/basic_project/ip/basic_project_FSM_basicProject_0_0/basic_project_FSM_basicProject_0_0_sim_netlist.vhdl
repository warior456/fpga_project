...
entity basic_project_FSM_basicProject_0_0_counter is
  port (
    \FSM_sequential_rFSM_current_reg[2]\ : out STD_LOGIC;
    ...
    \FSM_sequential_rFSM_current_reg[2]_1\ : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \FSM_sequential_rFSM_current_reg[2]_2\ : out STD_LOGIC;
...
\rShapeX_current[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \FSM_sequential_rFSM_current_reg[2]_2\
    );
...
\rShapeY_current[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      O => \FSM_sequential_rFSM_current_reg[2]_1\
    );
...
\rShapeY_current[8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I1 => \rShapeX_current[9]_i_4_n_0\,
      O => \FSM_sequential_rFSM_current_reg[2]\
    );
...
counter_inst: entity work.basic_project_FSM_basicProject_0_0_counter
     port map (
      ...
      \FSM_sequential_rFSM_current_reg[2]_0\ => \FSM_sequential_rFSM_current_reg[2]_0\,
      \FSM_sequential_rFSM_current_reg[2]_1\ => \FSM_sequential_rFSM_current_reg[2]_1\,
      \FSM_sequential_rFSM_current_reg[2]_2\ => \FSM_sequential_rFSM_current_reg[2]_2\,
...
architecture STRUCTURE of basic_project_FSM_basicProject_0_0_FSM_basicProject is
  ...
  signal wToggle_next : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_rFSM_current[0]_i_3\ : label is "soft_lutpair73";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_rFSM_current_reg[0]\ : label is "sUp:101,sDown:100,sLeft:011,sInit:010,sIdle:000,sRight:001";
  attribute FSM_ENCODED_STATES of \FSM_sequential_rFSM_current_reg[1]\ : label is "sUp:101,sDown:100,sLeft:011,sInit:010,sIdle:000,sRight:001";
  attribute FSM_ENCODED_STATES of \FSM_sequential_rFSM_current_reg[2]\ : label is "sUp:101,sDown:100,sLeft:011,sInit:010,sIdle:000,sRight:001";
  ...
  attribute SOFT_HLUTNM of \rShapeX_current[9]_i_7\ : label is "soft_lutpair72";
  ...
  attribute SOFT_HLUTNM of \rShapeY_current[9]_i_5\ : label is "soft_lutpair72";
...
\FSM_sequential_rFSM_current[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"88AA88AA880088A8"
    )
        port map (
      I0 => \FSM_sequential_rFSM_current[0]_i_3_n_0\,
      I1 => iRight,
      I2 => iLeft,
      I3 => rFSM_current(0),
      I4 => iDown,
...
\FSM_sequential_rFSM_current[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\rShapeY_current[8]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \^rshapey_current_reg[2]_0\,
      I2 => \rShapeY_current[8]_i_7_n_0\,
      I3 => \^rshapey_current_reg[3]_0\,
      I4 => \^rshapey_current_reg[4]_0\,
      I5 => \^rshapey_current_reg[5]_0\,
      O => \rShapeY_current[8]_i_6_n_0\
    );
\rShapeY_current[8]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\rShapeY_current[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA8"
    )
        port map (
      I0 => \rShapeY_current[9]_i_5_n_0\,
      I1 => \^rshapey_current_reg[8]_0\,
      I2 => \rShapeY_current[7]_i_5_n_0\,
      I3 => \^rshapey_current_reg[6]_0\,
      I4 => \^rshapey_current_reg[7]_0\,
...
\rShapeY_current[9]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
timer_50ms_inst: entity work.basic_project_FSM_basicProject_0_0_timer_n_s
     port map (
      ...
      \FSM_sequential_rFSM_current_reg[2]\ => timer_50ms_inst_n_0,
      \FSM_sequential_rFSM_current_reg[2]_0\ => timer_50ms_inst_n_1,
      \FSM_sequential_rFSM_current_reg[2]_1\ => timer_50ms_inst_n_7,
      \FSM_sequential_rFSM_current_reg[2]_2\ => timer_50ms_inst_n_12,
      Q(3 downto 0) => \^q\(3 downto 0),
      iClk => iClk,
      iRst => iRst,
      rFSM_current(2 downto 0) => rFSM_current(2 downto 0),
