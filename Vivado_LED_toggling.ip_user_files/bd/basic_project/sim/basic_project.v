...
module basic_project
  ...
  wire [9:0]FSM_basicProject_0_oPaddleSize1;
  wire [9:0]FSM_basicProject_0_oShapSize;
  wire [27:0]FSM_basicProject_0_oWalls;
  wire [9:0]FSM_basicProject_0_oXball;
  wire [9:0]FSM_basicProject_0_oYBall;
  ...
  basic_project_FSM_basicProject_0_0 FSM_basicProject_0
       (.iClk(clk_wiz_0_clk_25),
        ...
        .iRst(iSoftRst),
        .iUp(iPushUp),
        .oPaddleSize(FSM_basicProject_0_oPaddleSize1),
        .oWalls(FSM_basicProject_0_oWalls),
        .oXBall(FSM_basicProject_0_oXball),
        .oXPaddle(FSM_basicProject_0_oShapSize),
        .oYBall(FSM_basicProject_0_oYBall));
  ...
  basic_project_video_pattern_0_0 video_pattern_0
       (.iBallX(FSM_basicProject_0_oXball),
        .iBallY(FSM_basicProject_0_oYBall),
        .iClk(clk_wiz_0_clk_25),
        .iCountH(video_timings_0_oCountH),
        .iCountV(video_timings_0_oCountV),
        .iPaddleSize(FSM_basicProject_0_oPaddleSize1),
        .iPaddleX(FSM_basicProject_0_oShapSize),
        .iRst(iRst),
        .iWalls(FSM_basicProject_0_oWalls),
