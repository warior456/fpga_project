...
(* CHECK_LICENSE_TYPE = "timer_LED_toggling_design_Debounce_Switch_0_3,Debounce_Switch,{}" *) (* CORE_GENERATION_INFO = "timer_LED_toggling_design_Debounce_Switch_0_3,Debounce_Switch,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=Debounce_Switch,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,c_DEBOUNCE_LIMIT=250000}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "Debounce_Switch,Vivado 2025.1" *) 
module timer_LED_toggling_design_Debounce_Switch_0_3(i_Clk, i_Switch, o_Switch)
