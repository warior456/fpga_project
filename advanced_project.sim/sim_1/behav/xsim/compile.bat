...
REM
REM Generated by Vivado on Sat Nov 22 14:32:59 +0100 2025
...
echo "xvlog --incr --relax -prj FMS_Basicproject_TB_vlog.prj"
call xvlog  --incr --relax -prj FMS_Basicproject_TB_vlog.prj -log xvlog.log
